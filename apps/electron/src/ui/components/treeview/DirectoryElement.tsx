        ...
        <div className="loc-h-card-content-con">
            ...
            <div className="loc-h-tools">
                <div className="dropdown">
                    <img style={{cursor: 'pointer', width: "30px", padding: "4px", margin: "4px"}} src={'assets/images/svg/enter_1_placeholder.svg'}
                         alt="more-options"
                         data-bs-toggle="modal" data-bs-target="#shareModal"
                         onClick={callbackEnterDirectory}/>

                    <img className="dropdown-toggle" src={'assets/images/svg/ic_team_dropdown.svg'}
                         alt="more-options" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"/>
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li className="dropdown-item">
                            <img style={{width: "35px"}} src={'assets/images/svg/user_default.svg'}
                                 alt="user"/>
                            <div>Jason Roy</div>
                        </li>
                        <li className="dropdown-item">
                ...
                <div className="dropdown">
                    <img className="dropdown-toggle" style={{width: "5px"}}
                         src={'assets/images/svg/ic_3_dots.svg'} alt="more-options" id="dropdownMenuButton2"
