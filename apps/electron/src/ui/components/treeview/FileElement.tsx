      ...
      <div className="loc-h-card-content-con">
        ...
        <div className="loc-h-tools">
          <div className="dropdown">
            <img className="dropdown-toggle" src="assets/images/svg/ic_team_dropdown.svg" alt="more-options"
          ...
          <img style={{ cursor: 'pointer' }} src={'assets/images/svg/ic_share.svg'} alt="more-options" data-bs-toggle="modal"
               data-bs-target="#shareModal" onClick={() => setSelectFile(fileDescription)} />
          <div className="dropdown">
            <img className="dropdown-toggle" style={{ width: '5px' }} src={'assets/images/svg/ic_3_dots.svg'}
                 alt="more-options" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false" />
