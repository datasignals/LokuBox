  ...
  return (
    <div>
                  ...
                  <ul className='loc-view-toggle-con'>
                    <li className={view === "list" ? "active" : ""} onClick={() => handleToggleView("list")}>
                      <svg xmlns='http://www.w3.org/2000/svg' width='13' height='12' viewBox='0 0 13 12'>
                        <path
                          id='ic_list'
                          d='M3831.866-739a.862.862,0,0,1-.867-.857.862.862,0,0,1,.867-.857h11.267a.861.861,0,0,1,.866.857.862.862,0,0,1-.866.857Zm0-5.143A.862.862,0,0,1,3831-745a.862.862,0,0,1,.867-.857h11.267A.862.862,0,0,1,3844-745a.862.862,0,0,1-.866.858Zm0-5.144a.862.862,0,0,1-.867-.857.862.862,0,0,1,.867-.857h11.267a.862.862,0,0,1,.866.857.862.862,0,0,1-.866.857Z'
                          transform='translate(-3830.999 751)'
                        />
                      </svg>
                    </li>
                    <li className={view === "grid" ? "active" : ""} onClick={() => handleToggleView("grid")}>
                      <svg
                        ...
                        width='14.654'
                        height='13.957'
                        viewBox='0 0 14.654 13.957'
                      >
                        <path
                          id='ic_grid'
                          d='M55.456,47.676h-2.2a2.148,2.148,0,0,0-2.2,2.093v2.093a2.148,2.148,0,0,0,2.2,2.093h2.2a2.148,2.148,0,0,0,2.2-2.093V49.769a2.148,2.148,0,0,0-2.2-2.093m-8.06,0H45.2A2.148,2.148,0,0,0,43,49.769v2.093a2.148,2.148,0,0,0,2.2,2.093h2.2a2.148,2.148,0,0,0,2.2-2.093V49.769a2.148,2.148,0,0,0-2.2-2.093M55.456,40h-2.2a2.148,2.148,0,0,0-2.2,2.093v2.093a2.148,2.148,0,0,0,2.2,2.093h2.2a2.148,2.148,0,0,0,2.2-2.093V42.093A2.148,2.148,0,0,0,55.456,40m-5.862,2.093v2.093a2.148,2.148,0,0,1-2.2,2.093H45.2A2.148,2.148,0,0,1,43,44.187V42.093A2.148,2.148,0,0,1,45.2,40h2.2a2.148,2.148,0,0,1,2.2,2.093'
                          transform='translate(-43 -39.999)'
                          fillRule='evenodd'
                        />
                      </svg>
                    </li>
                    ...
                    <div className='loc-h-card-content-con'>
                      ...
                      <div className='loc-h-tools'>
                        <div className='loc-s-users'>
                          <img src={"assets/images/svg/user_default.svg"} alt='' />
      ...
      <div className='loc-h-content-details'>
        <div className='loc-h-content-title'>Notifications</div>
        <div className='loc-s-activity-content-con' style={{ marginTop: "20px" }}>
          <div className='loc-card' style={{ height: "100%" }}>
            <div className='loc-s-activity-content'>
              ...
              <div>
                <img style={{ cursor: "pointer" }} src={"assets/images/svg/ic_reject.svg"} alt='' />
                <img style={{ marginLeft: "10px", cursor: "pointer" }} src={"assets/images/svg/ic_check.svg"} alt='' />
              </div>
            </div>
          </div>
        </div>
