...
export const Home: FC<{ routePath: string }> = ({routePath}) => {
    ...
    const fetchNfsContents = (): void => {
      setFiles([
        {
          filename: "file1", creationDate: 0
        },
        {
          filename: "file2", creationDate: 0
        },
        {
          filename: "file3", creationDate: 0
        }
      ]);
      setDirectories([
        "Dir1", "Dir2"
    ...
    return (
      <div>
        <h1>debug: {createDirectoryModalVisible.toString()}</h1>
        <Layout />
                ...
                <div className="loc-card loc-h">
                  <div className="position-relative" style={{ width: '350px' }}>
                    ...
                    <img style={{ position: 'absolute', top: '12px', right: '15px' }}
                         src="assets/images/svg/ic_search.svg" alt="" />
                  </div>
                </div>
                <div>
                  {allFilesElement}
