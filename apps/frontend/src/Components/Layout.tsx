                ...
                <ul className="loc-nav-menu">
                    <li>
                        ...
                        <div className="dropdown">
                            <img className="dropdown-toggle" src={'../../public/assets/images/svg/user_default.svg'} alt="more-options" id="dropdownMenuAccount" data-bs-toggle="dropdown" aria-expanded="false"/>
